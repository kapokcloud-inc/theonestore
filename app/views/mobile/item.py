...
def index():
    ...
    data['paging_url'] = url_for('mobile.item.paging', **request.args)

    return render_template('mobile/item/index.html.j2', **data)
...
def paging():
    ...
    return render_template('mobile/item/paging.html.j2', **data)
...
def recommend():
    ...
    data['paging_url'] = url_for('mobile.item.paging', **params)

    return render_template('mobile/item/recommend.html.j2', **data)
...
def hot():
    ...
    return render_template('mobile/item/hot.html.j2', **data)
