...
def root():
    ...
    recommend_items = ItemStaticMethodsService.items(
        {'is_recommend': 1, 'p': 1, 'ps': 12})

    return render_template('pc/index/index.html.j2', advs=advs, hot_items=hot_items, recommend_items=recommend_items)
